...
class SettingsScreen extends StatelessWidget {
              ...
              Card(
                  ...
                  child: Column(children: [
                            ...
                            Row(children: [
                              Expanded(
                                  child: _ThemeCard(
                                      ...
                                      label: l10n.settings_system,
                                      value: 'system',
                                      selected: s.themeMode,
                                      cs: cs,
                                      onTap: () => app.updateSetting(
                                          'themeMode', 'system'))),
                              const SizedBox(width: 8),
                              Expanded(
                                  child: _ThemeCard(
                                      icon: Icons.light_mode_outlined,
                                      label: l10n.settings_light,
                                      value: 'light',
                                      selected: s.themeMode,
                                      cs: cs,
                                      onTap: () => app.updateSetting(
                    ...
                    SwitchListTile(
                      ...
                      secondary: Icon(Icons.format_paint_outlined,
                          color: cs.primary, size: 20),
                      title: Text(l10n.settings_dynamicColor,
                          style: const TextStyle(
                              fontWeight: FontWeight.w700, fontSize: 14)),
                      subtitle: Text(l10n.settings_dynamicColorSubtitle,
                          style: TextStyle(
                              fontSize: 12,
                            ...
                            children: [
                              Row(children: [
                                ...
                                Column(
                                    ...
                                    children: [
                                      Text(l10n.settings_accentColor,
                                          style: const TextStyle(
                                              fontWeight: FontWeight.w700,
                                              fontSize: 14)),
                                      Text(
                                          kSeedLabels[s.themeSeed] ??
                                              s.themeSeed,
                                          style: TextStyle(
                                              fontSize: 12,
                                              color: cs.onSurface
                              ...
                              Wrap(
                                  spacing: 8,
                                  runSpacing: 8,
                                  children: kSeedColors.entries.map((e) {
                  ...
                  child: Column(children: [
                    ListTile(
                      ...
                      trailing: DropdownButton<String>(
                        ...
                        items: [
                          DropdownMenuItem(
                              value: 'monday',
                              child: Text(l10n.settings_monday)),
                          DropdownMenuItem(
                              value: 'sunday',
                              child: Text(l10n.settings_sunday)),
                        ],
                        onChanged: (v) {
                    ...
                    SwitchListTile.adaptive(
                      secondary: Icon(Icons.notifications_active_outlined,
                          color: cs.primary),
                      title: Text(l10n.settings_budgetAlerts,
                          style: const TextStyle(
                              fontWeight: FontWeight.w700, fontSize: 14)),
                      subtitle:
                    ...
                    if (s.dailyReminderEnabled) ...[
                      ListTile(
                        ...
                        title: Text(l10n.settings_reminderTime,
                        ...
                        onTap: () async {
                          final initial = TimeOfDay(
                            hour: int.tryParse(
                                    s.dailyReminderTime.split(':')[0]) ??
                                22,
                            minute: int.tryParse(
                                    s.dailyReminderTime.split(':')[1]) ??
                                0,
                          );
              ...
              Card(
                  ...
                  child: Column(children: [
                    ...
                    ListTile(
                      ...
                      title: Text(l10n.settings_github,
                          style: const TextStyle(fontWeight: FontWeight.w700)),
                    ...
                    ListTile(
                      leading:
                          Icon(Icons.person_outline_rounded, color: cs.primary),
                      title: Text(l10n.settings_developer,
                          style: const TextStyle(fontWeight: FontWeight.w700)),
                              ...
                              children: [
                                ...
                                ListTile(
                                  ...
                                  onTap: () async {
                                    Navigator.pop(ctx);
                                    final uri = Uri.parse(
                                        'https://portfolio.minaashraf285.workers.dev');
                                    if (await canLaunchUrl(uri)) {
                                      await launchUrl(uri,
                                          mode: LaunchMode.externalApplication);
                                    }
  ...
  String _langName(BuildContext context, String code) {
    ...
    switch (code) {
      ...
      case 'it':
        return 'Italiano';
      default:
        return l10n.settings_systemDefault;
    }
  }
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _langTile('Español', 'es', current, ctx),
            _langTile('Português', 'pt', current, ctx),
            _langTile('中文', 'zh', current, ctx),
            _langTile('日本語', 'ja', current, ctx),
            _langTile('Русский', 'ru', current, ctx),
            _langTile('Italiano', 'it', current, ctx),
          ],
        ),
      ),
    );
  ...
  Widget _langTile(
      String label, String code, String current, BuildContext ctx) {
    ...
    return ListTile(
      ...
      title: Text(label,
          style:
              TextStyle(fontWeight: sel ? FontWeight.bold : FontWeight.normal)),
